...
accessibility on the web is essentially making a webpage cleanly viewable to any user regardless of device.

2. Talk about 3 different things you can do to ensure your website is accessible.

using proper semantic html, using scalable widths, using alt text.
 
3. How would you explain the concept of a variable to someone new to programming?

a variable is just a way store information, and are labeled to to be able to access them later.

4. What is the purpose of using functions in code?

functions can be used endless amounts of times and save a ton of space and writing time.
